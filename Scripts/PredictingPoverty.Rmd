...
# Reescalar variable Nivel_educativo en train_hogares_final
train_hogares_final <- train_hogares_final %>%
  mutate(
    Nivel_educativo = case_when(
      Nivel_educativo == 9 ~ NA_character_,  # convertir "No sabe / no informa" en NA
    ...
    Nivel_educativo = factor(
      Nivel_educativo,
      levels = c("Ninguno", "Preescolar", "Máximo bachiller", "Superior o universitaria"),
      ordered = TRUE
    )
  )

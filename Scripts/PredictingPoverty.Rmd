...
train_hogares_final <- train_hogares_final %>%
  drop_na(Pobre, Clase, Dominio, Tipo_vivienda, Nper, Depto,
...
pred_prob <- predict(arbol_podado, newdata = test_hogares_final, type = "prob")
test_hogares_final$Prob_Pobre <- pred_prob[, 2]

# --- Predicciones de clase ---
predictSample <- test_hogares_final |>
  mutate(Pobre = predict(arbol_podado, newdata = test_hogares_final, type = "class")) |>
  select(id, Pobre)
